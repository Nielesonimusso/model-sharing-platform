...
def get_schema_classes() -> List:
    ...
    return [*product_schemas(), *model_schemas(), *simulation_schemas(), *user_schemas(), IngredientInfoDtoSchema,
            ModelResultDtoSchema, RunModelDtoSchema, ModelRunStatusDtoSchema]
